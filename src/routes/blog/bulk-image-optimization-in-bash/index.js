...
28k     ./images/estelle.jpg`}</CodeBlock>
				...
				<SubHeading deepLink={"jpeg-recompress"}>Bulk JPEG optimization with jpeg-recompress</SubHeading>
				...
				<SubHeading deepLink={"optipng"}>Bulk PNG optimization with OptiPNG</SubHeading>
				...
				<SubHeading deepLink={"svgo"}>Bulk SVG optimization with svgo</SubHeading>
				...
				<SubHeading deepLink={"conclusion"}>Conclusion</SubHeading>
