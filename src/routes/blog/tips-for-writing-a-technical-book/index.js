...
export default class Content extends Component{
	render(){
		return (
			<article>
				{Excerpt}
				<SubHeading deepLink={"dont-do-it-for-the-money"}>1. Don't do it for the money</SubHeading>
				...
				<SubHeading deepLink={"family-and-friends"}>2. Tell your family and friends you're going away for a while</SubHeading>
				...
				<SubHeading deepLink={"dont-be-a-jerk"}>3. Don't be a jerk to the people who have to work with you</SubHeading>
				...
				<SubHeading deepLink={"youre-probably-replaceable"}>4. You're (probably) replaceable</SubHeading>
				...
				<SubHeading deepLink={"deal-with-depression"}>5. Learn to deal with crushing depression</SubHeading>
				...
				<SubHeading deepLink={"take-breaks"}>6. Take strategically timed breaks</SubHeading>
				...
				<SubHeading deepLink={"schedule"}>7. You're probably not going to stay on schedule</SubHeading>
				...
				<SubHeading deepLink={"stress-is-normal-sometimes"}>8. Stress is normal, and okay (but only sometimes)</SubHeading>
				...
				<SubHeading deepLink={"take-time-off"}>9. Take time off afterward</SubHeading>
